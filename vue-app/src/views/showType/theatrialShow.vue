<template>
  <div class="theatrialShow">
    ...
    <div class="shows-container">
      <div class="show-item" v-for="item in theatrialShowList" :key="item.id" @click="toShowDetail(item.id)">
...
export default {
  ...
  methods: {
    async getShowByCity(city, index) {
      ...
      const { data } = await getShowList({ type: '舞台剧' })
      this.theatrialShowList = data.filter(item => item.hall.city === city)
      console.log(this.theatrialShowList)
    },
    toShowDetail(id) {
