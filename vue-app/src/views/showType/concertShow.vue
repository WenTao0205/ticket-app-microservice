<template>
  <div class="concertShow">
    ...
    <div class="shows-container">
      <div class="show-item" v-for="item in concertShowList" :key="item.id" @click="toShowDetail(item.id)">
...
export default {
  ...
  methods: {
    async getShowByCity(city, index) {
      ...
      const { data } = await getShowList({ type: '演唱会' })
      this.concertShowList = data.filter(item => item.hall.city === city)
      console.log(this.concertShowList)
    },
    toShowDetail(id) {
