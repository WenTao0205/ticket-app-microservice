<template>
  <div class="instrumentShow">
    ...
    <div class="shows-container">
      <div class="show-item" v-for="item in instrumentShowList" :key="item.id" @click="toShowDetail(item.id)">
...
export default {
  ...
  methods: {
    async getShowByCity(city, index) {
      ...
      const { data } = await getShowList({ type: '音乐会' })
      this.instrumentShowList = data.filter(item => item.hall.city === city)
      console.log(this.instrumentShowList)
    },
    toShowDetail(id) {
