<template>
  <div>
    ...
    <div>
      <el-form style="width: 350px;float: left" label-position="top" :model="user" ref="form" label-width="80px">
        ...
        <el-form-item label="个人简介">
          <el-input :rows="5" type="textarea" v-model="user.personalIntro"></el-input>
        </el-form-item>
...
import { alterUserInfo } from '../../api/users'
...
export default {
  ...
  methods: {
    ...
    async onSubmit() {
      const res = await alterUserInfo(this.user)
      Notification.success({ message: '个人信息修改成功' })
    },
